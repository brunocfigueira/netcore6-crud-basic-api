...
[ApiController]
[Route("[controller]")]
public class PermissionsController : ControllerBase, ICrudController<CreatePermissionDto, UpdatePermissionDto, ReadPermissionDto>
{
    ...
    public IActionResult Create([FromBody] CreatePermissionDto resquest)
    {
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    public IActionResult Update(long id, [FromBody] UpdatePermissionDto resquest)
    {
        try
        {
    ...
    [HttpGet("search")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    public IEnumerable<ReadPermissionDto> Search([FromQuery] int skip = 0, [FromQuery] int take = 10)
    {
